					...
					<div class="col-lg-12">
						<div class="panel panel-primary">
						  	<div class="panel-heading">
						    	<h3 class="panel-title"><span class="glyphicons notes"><i></i></span> Payments Report
						  		...
						  		<?php
								    ...
								    while ($i<=$end ) {								    
								    	...
								    	<tr>
								    		...
								    		<td><a class="badge badge-info amount" href="<?php echo 'contributions_list.php?date='.$date;?>">Php <?php echo $rand[rand(0,2)];?></a></td>
								    		<td><a class="badge badge-info amount" href="<?php echo 'loans_list.php?date='.$date;?>">Php <?php echo $rand[rand(0,2)];?></a></td>
								    	</tr>
								    	<?php
								    	$a++;								    	
								    }
