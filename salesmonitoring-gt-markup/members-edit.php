					...
					<div class="col-lg-12">
						<div class="panel panel-primary">
						  	<div class="panel-heading">
						    	<h3 class="panel-title"><span class="glyphicons user"><i></i></span>Edit Member
						  	...
						  	<div class="panel-body">
						  		 <?php include 'form-members-edit.php';?>
						  		 <hr>
						  		 <div class="modal-footer">
			        				<a href="members.php" class="btn">Cancel</a>
                                    <a href="members.php" class="btn btn-primary">Save</a>
			        			</div>							    
                        	</div>
                        </div>
					</div><!--/col-->	
