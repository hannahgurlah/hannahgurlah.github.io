					...
					<div class="col-lg-12">
						<div class="panel panel-primary">
						  	<div class="panel-heading">
						    	<h3 class="panel-title"><span class="glyphicons notes"><i></i></span> Edit Product
								...
								<div class="col-md-10 col-md-offset-1">
								    <form role="form">
								        ...
								        <div class="input-group col-lg-12">                 
								            <textarea class="form-control">This is just a test product</textarea>
								        </div>
								        <br>
								        ...
								        <div class="input-group">
								          ...
								          <input type="text" class="form-control" value="Php 200.00">
								        </div>
								        <br>
