						  		...
						  		<?php
								    ...
								    while ($i<=$end ) {								    
								    	...
								    	<tr>
								    		...
								    		<td><a class="badge badge-info" href="<?php echo "applications_list.php?type=membership&cnt=$new&date=".date('Y-m-d', $i);?>"><?php echo $new;?></a></td>
								    		<td><a class="badge badge-warning" href="<?php echo "applications_list.php?type=loan&cnt=$inactive&date=".date('Y-m-d', $i);?>"><?php echo $inactive;?></a></td>
								    		<td><a class="badge badge-error" href="<?php echo "applications_list.php?type=member_update&cnt=$terminated&date=".date('Y-m-d', $i);?>"><?php echo $terminated;?></a></td>
								    	</tr>
								    	<?php
								    	$a++;								    	
								    }
