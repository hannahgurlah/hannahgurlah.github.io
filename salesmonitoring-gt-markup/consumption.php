					...
					<div class="col-lg-12">
						<div class="panel panel-primary">
						  	<div class="panel-heading">
						    	<h3 class="panel-title"><span class="glyphicons stats"><i></i></span> Sto. Nino Subdivision  Facility Fees
						  	...
						  	<div class="panel-body">
								...
								<button class="btn btn-primary btn-lg" data-toggle="modal" data-target="#myModal">
									  <i class="icon-plus-sign"></i> Add New Facility Fee
									</button>
						  		</div>
						  		<hr>
<br><br>
						  		<div class="row">
						  			<div class="col-lg-12">
						  				<div class="well">
						  					<h3>Total Paid for Facility Fees as of February 2014</h3>
						  					<h1 class="red">Php 592,149.00</h1>
						  					<h3 class="blue"><small>Fee from Active Members:</small> Php 524,563.25</h3>
						  					<h3 class="blue"><small>Fee from Passive Members:</small> Php 67,585.75</h3>
						  					<br>
						  				</div>
						  			</div>
						  		...
						  		<h2>Listing of Facilities Fee</h2>
							  ...
							  <tbody>
							  	...
							  	<tr>
										<td class="center">
											<?php 
												$types = array('Club House','Basketball Court','Playground');
