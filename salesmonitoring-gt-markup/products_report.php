					...
					<div class="col-lg-12">
						<div class="panel panel-primary">
						  	<div class="panel-heading">
						    	<h3 class="panel-title"><span class="glyphicons notes"><i></i></span> Products Inventory Report
						  	...
						  	<div class="panel-body">
						  		...
						  		<?php
								    ...
								    while ($i<=$end ) {								    
								    	...
								    	<tr>
								    		<td><?php echo $date;?></td>
								    		<td><a class="badge badge-info amount" href="<?php echo 'products_list.php?date='.$date;?>">Php <?php echo $rand[rand(0,2)];?></a></td>
