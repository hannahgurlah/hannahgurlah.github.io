					...
					<div class="col-lg-12">
						<div class="panel panel-primary">
						  	<div class="panel-heading">
						    	<h3 class="panel-title"><span class="glyphicons notes"><i></i></span> Loan Application Form 
						  	...
						  	<div class="panel-body">
						  		 <?php include 'form-loan-application.php';?>
						  		 <hr>
						  		 <div class="modal-footer">
			        <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
			        <a href="loandetails.php" class="btn btn-primary">Submit Loan Application</a>
			      </div>
