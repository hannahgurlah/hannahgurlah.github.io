					...
					<div class="col-lg-12">
						<div class="panel panel-success">
						  	...
						  	<div class="panel-body">
						  		...
						  		<h1><?php echo ucfirst($_REQUEST['status']);?> Members (<?php echo $_REQUEST['date'];?> ) </h1>
						  		<table class="table table-bordered table-striped">
						  			...
						  			<tbody>
										...
										<tr>
											...
											<td class="center">
												<?php echo (@$member[3]=='bod')?'Active':'';?>
												<?php echo (@$member[3]=='associate')?'Passive':'';?>
												<?php echo (empty($member[3]))?'Active':'';?>
											</td>
											<td class="center">
